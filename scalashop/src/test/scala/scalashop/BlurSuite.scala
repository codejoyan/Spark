...
class BlurSuite {
  ...
  @Test def `HorizontalBoxBlur.blur with radius 1 should correctly blur the entire 3x3 image` {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  @Test def `VerticalBoxBlur.blur with radius 2 should correctly blur the entire 4x3 image` {
    val w = 4
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
